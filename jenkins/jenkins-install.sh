...
then
	...
	#Install Java SDK 11
#	apt install -y default-jdk &> "$log_file"
#	apt-get install -y openjdk-11-jdk &> "$log_file"
...
then
	...
	#Install Java
	yum install -y java-1.8.0-openjdk-devel &> "$log_file"
